...
feat_scal_u, feat_scal_s = True, False
if feat_scal_u:
...
it, lr = 1000, eval(sys.argv[1]) if len(sys.argv) >= 2 else 300

prev_gra = np.zeros(w.shape) # adagrad
prev_loss = math.inf

input('='*31+'Data Loaded'+'='*31+'\n')
#### rec = 0
