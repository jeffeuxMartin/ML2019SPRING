...
class Preprocess():
    ...
    def get_embedding(self, load=False):
        ...
        self.vectors.append(uniform_(empty(1, 100)).numpy())
...
class RNNModel:
    def __init__(self, args, prep):
        ...
        self.model.add(Embedding(*(prep.vectors.shape), 
    ...
    def compile(self):
        ...
        checkpointer = ModelCheckpoint(
            filepath=('model_best_{}.h5'.format(self.now)),
    ...
    def Save_pred(self, Y):
        print("Saving the prediction as", 
              'prediction_best_{}.csv'.format(self.now), "...")
        with open('prediction_best_{}.csv'.format(self.now), 'w') as f: 
            f.write('id,label\n') 
